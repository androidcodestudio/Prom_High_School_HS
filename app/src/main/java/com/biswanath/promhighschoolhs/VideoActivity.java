...
import com.biswanath.promhighschoolhs.adapters.PlaybackIconsAdapter;
import com.biswanath.promhighschoolhs.models.BrightnessDialog;
import com.biswanath.promhighschoolhs.models.IconModel;
import com.biswanath.promhighschoolhs.models.OnSwipeTouchListener;
import com.biswanath.promhighschoolhs.models.VolumeDialog;
...
//        getSupportActionBar().hide();
        ...
        _videoUrl = getIntent().getStringExtra("videoUrl");
...
//                    });
    ...
    private void playError() {
        player.addListener(new Player.EventListener() {
            ...
            public void onPlayerError(ExoPlaybackException error) {
                Toast.makeText(VideoActivity.this, "Video Playing Error", Toast.LENGTH_SHORT).show();
            }
        });
        player.setPlayWhenReady(true);
    }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.video_back){
            ...
            Toast.makeText(this, "no more Video", Toast.LENGTH_SHORT).show();
        }
    ...
    View.OnClickListener firstListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(VideoActivity.this, "Full Screen", Toast.LENGTH_SHORT).show();
    ...
    View.OnClickListener secondListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(VideoActivity.this, "Zoom", Toast.LENGTH_SHORT).show();
    ...
    View.OnClickListener thirdListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(VideoActivity.this, "Fit", Toast.LENGTH_SHORT).show();
            scaling.setOnClickListener(firstListener);
        }
    };
