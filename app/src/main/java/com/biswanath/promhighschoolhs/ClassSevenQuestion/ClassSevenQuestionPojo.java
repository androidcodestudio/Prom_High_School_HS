...
public class ClassSevenQuestionPojo {
    ...
    public ClassSevenQuestionPojo() {
    }

    public ClassSevenQuestionPojo(int setNo, String question, String op_one, String op_two, String op_three, String op_four, String correct_ans) {
        this.setNo = setNo;
