package com.biswanath.promhighschoolhs.ClassSevenQuestion;
...
public class ClassSevenQuestionActivity extends AppCompatActivity {
    ...
    private List<ClassSevenQuestionPojo> bookmarkList;
    ...
    private List<ClassSevenQuestionPojo> question_pojos;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_class_seven_question);
        ...
        loadingDialog.show();
        myRef.child("CLASS_SEVEN_SETS").child(category).child("questions").orderByChild("setNo").equalTo(setNo).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    question_pojos.add(dataSnapshot.getValue(ClassSevenQuestionPojo.class));
                    if (question_pojos.size()>0){
                        ...
                        next_btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (position == question_pojos.size()) {
                                    Intent score_intent = new Intent(ClassSevenQuestionActivity.this, ScoreActivity.class);
                        ...
                        finish();
                        Toast.makeText(ClassSevenQuestionActivity.this, "no  question", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ClassSevenQuestionActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                loadingDialog.dismiss();
                finish();
            }
        });
    ...
    private void getBookmark(){
        ...
        Type type = new TypeToken<List<ClassSevenQuestionPojo>>(){}.getType();
    ...
    private boolean modelMatch(){
        ...
        int i = 0;
        for (ClassSevenQuestionPojo pojo : bookmarkList){
