...
public class ClassEightQuestionActivity extends AppCompatActivity {
    ...
    private List<ClassEightQuestionPojo> bookmarkList;
    ...
    private List<ClassEightQuestionPojo> question_pojos;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_class_eight_question);
        ...
        loadingDialog.show();
        myRef.child("CLASS_EIGHT_SETS").child(category).child("questions").orderByChild("setNo").equalTo(setNo).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    question_pojos.add(dataSnapshot.getValue(ClassEightQuestionPojo.class));
                    if (question_pojos.size()>0){
                        ...
                        next_btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (position == question_pojos.size()) {
                                    Intent score_intent = new Intent(ClassEightQuestionActivity.this, ScoreActivity.class);
                        ...
                        finish();
                        Toast.makeText(ClassEightQuestionActivity.this, "no  question", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ClassEightQuestionActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                loadingDialog.dismiss();
                finish();
            }
        });
    ...
    private void getBookmark(){
        ...
        Type type = new TypeToken<List<ClassEightQuestionPojo>>(){}.getType();
    ...
    private boolean modelMatch(){
        ...
        int i = 0;
        for (ClassEightQuestionPojo pojo : bookmarkList){
