package com.biswanath.promhighschoolhs.ClassFiveQuestion;
...
public class ClassFiveQuestionActivity extends AppCompatActivity {
    ...
    private List<ClassFiveQuestionPojo> bookmarkList;
    ...
    private int Score = 0;
    private String category,setName;
    private int setNo;

    private Window _window;

    private List<ClassFiveQuestionPojo> question_pojos;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_class_five_question);
...
//        loadingDialog.setCancelable(false);
        ...
        myRef.child(setName)
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    question_pojos.add(dataSnapshot.getValue(ClassFiveQuestionPojo.class));
                    if (question_pojos.size()>0){
                        ...
                        next_btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (position == question_pojos.size()) {
                                    Intent score_intent = new Intent(ClassFiveQuestionActivity.this, ScoreActivity.class);
                        ...
                        finish();
                        Toast.makeText(ClassFiveQuestionActivity.this, "no  question", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ClassFiveQuestionActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                //loadingDialog.dismiss();
                finish();
            }
        });
    ...
    private void getBookmark(){
        ...
        Type type = new TypeToken<List<ClassFiveQuestionPojo>>(){}.getType();
    ...
    private boolean modelMatch(){
        ...
        int i = 0;
        for (ClassFiveQuestionPojo pojo : bookmarkList){
    ...
    public void onBackPressed() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setMessage("Are you sure you want to close ? If You Close it Your All Score Will Be Deducted")
