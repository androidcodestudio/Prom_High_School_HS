package com.biswanath.promhighschoolhs.ClassNineQuestion;
...
public class ClassNineQuestionActivity extends AppCompatActivity {
    ...
    private List<ClassNineQuestionPojo> bookmarkList;
    ...
    private List<ClassNineQuestionPojo> question_pojos;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_class_nine_question);
        ...
        myRef.child("CLASS_NINE_SETS")
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    question_pojos.add(dataSnapshot.getValue(ClassNineQuestionPojo.class));
                    if (question_pojos.size()>0){
                        ...
                        next_btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (position == question_pojos.size()) {
                                    Intent score_intent = new Intent(ClassNineQuestionActivity.this, ScoreActivity.class);
                        ...
                        finish();
                        Toast.makeText(ClassNineQuestionActivity.this, "no  question", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ClassNineQuestionActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                loadingDialog.dismiss();
                finish();
            }
        });
    ...
    private void getBookmark(){
        ...
        Type type = new TypeToken<List<ClassNineQuestionPojo>>(){}.getType();
    ...
    private boolean modelMatch(){
        ...
        int i = 0;
        for (ClassNineQuestionPojo pojo : bookmarkList){
